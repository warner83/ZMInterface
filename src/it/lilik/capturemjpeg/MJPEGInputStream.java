...
public class MJPEGInputStream extends FilterInputStream {
	...
	private static final int BYTES_TO_READ = 20; // The longer the faster, however the longer the higher the probability of a frame to be lost is
	 ...
	 */
	public byte[] readImage() throws IOException { // This whole thing should be rewritten using Java Scanner class
