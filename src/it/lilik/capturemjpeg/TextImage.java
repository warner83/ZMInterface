 ...
 *
 */
public class TextImage extends BufferedImage {
	
	/**
	 * Builds a {@link java.awt.image.BufferedImage} from the given text string
	 * <code>text</code>.
	 * 
	 * @param text the string message to be printed over the image.
	 */

	public TextImage (String text) {
		//creates the BufferedImage
		super (400, 300, BufferedImage.TYPE_INT_RGB);
		...
		graph.setFont(new Font("Arial", 1, 24));
